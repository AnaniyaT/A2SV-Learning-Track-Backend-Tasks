...
public class CommentManagerTests
{
    ...
    public void GetById_ReturnsCommentWithMatchingId()
    {
        ...
        // Act
        var result = commentManager.GetById(2);
    ...
    public void GetByPostID_ReturnsCommentsWithMatchingPostID()
    {
        ...
        // Act
        var result = commentManager.GetByPostId(1);
    ...
    public void Create_CreatesAndReturnsNewlyCreatedComment()
    {
        ...
        // Act
        var result = commentManager.Create(commentToCreate);
    ...
    public void Update_UpdatesAndReturnsUpdatedComment()
    {
        ...
        // Act
        var result = commentManager.Update(2, "Comment 2 edited");
    ...
    public void Update_ThrowsExceptionWhenCommentDoesNotExist()
    {
        ...
        // Act and Assert
        Assert.Throws<InvalidOperationException>(() => commentManager.Update(4, "Comment 4 edited"));
    }
