...
public class PostServiceTests
{
    ...
    public void GetById_ReturnsPostWithMatchingId()
    {
        ...
        // Act
        var result = postService.GetById(2);
    ...
    public void Create_CreatesAndReturnsNewlyCreatedPost()
    {
        ...
        // Act
        var result = postService.Create(postToCreate);
    ...
    public void Update_UpdatesAndReturnsUpdatedPost()
    {
        ...
        // Act
        var result1 = postService.Update(1, title: "Post 1 edited");
        var getResult1 = context.Posts.Find(1);

        var result2 = postService.Update(2, content: "Content 2 edited");
        var getResult2 = context.Posts.Find(2);

        var result3 = postService.Update(3, "Post 3 edited", "Content 3 edited");
    ...
    public void Update_ThrowsExceptionWhenPostDoesNotExist()
    {
        ...
        // Act and Assert
        Assert.Throws<InvalidOperationException>(() => postService.Update(4, "Post 4 edited"));
    }
